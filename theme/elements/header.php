...
<div id='header'>
  ...
  <div id="slideshow">
    ...
    <img src="<?php echo BASE_URL;?>/uploads/slide1.png" alt="Ben Kr&#246;se - Toekomstige Zorg" />
    <img src="<?php echo BASE_URL;?>/uploads/slide2.png" alt="Kevin Warwick - Cybernetica" />
    <img src="<?php echo BASE_URL;?>/uploads/slide3.png" alt="Jacobijn Sandberg - Mobiel Leren" />
    <img src="<?php echo BASE_URL;?>/uploads/slide5.png" alt="Theo Gevers - Interactive Advertising" />
    <img src="<?php echo BASE_URL;?>/uploads/slide6.png" alt="Pieter Jonker - Augmented Reality" />
    <img src="<?php echo BASE_URL;?>/uploads/slide7.png" alt="Rejo Zenger - Netneutraliteit" />
    <img src="<?php echo BASE_URL;?>/uploads/slide8.png" alt="Dariu Gavrilla - Autonome Auto's" />
  </div><!-- slideshow -->
</div> <!-- header -->
<div id='menu'>
