...
/* Parent pages */
$parent_pages = $controller->select_all_by_tag_with_order('parent_ID', 0, 'page', 'menu_priority DESC');
...
$list .= '<li><a href="http://en.awesomeit.nl"><span style="color: red;">English</span></a></li>';
